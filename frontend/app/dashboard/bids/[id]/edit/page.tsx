...
export default function EditBidPage({ params }: PageProps) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "@container rounded-xl border-succulent/20 dark:border-succulent/20 border overflow-hidden shadow-xl shadow-zinc-700/50 dark:[box-shadow:0_4px_20px_rgb(14_165_233/0.4)]",
