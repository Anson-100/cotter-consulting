...
const navigation: { main: NavLink[]; social: SocialLink[] } = {
  ...
  social: [
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/raeannacotter/",
      icon: (props) => (
        <svg {...props} fill="currentColor" viewBox="0 0 24 24">
...
export default function FooterSection({ setSelectedPage }: Props) {
  ...
  return (
    <footer className="flex flex-col bg-zinc-900 dark:bg-zinc-950">
      <button
        onClick={handleBackToTop}
        className="w-full cursor-pointer bg-zinc-900 py-3 text-center font-semibold text-gray-200 hover:bg-zinc-950"
      >
        Back to top
      </button>

      <div className="mx-auto mb-2 flex max-w-7xl flex-col items-center justify-center px-6 pt-16 lg:px-8">
        ...
        <p className="mt-12 text-center text-gray-500">
          &copy; {new Date().getFullYear()} Cotter Consulting LLC. All rights
          reserved.
        </p>
      </div>
    </footer>
