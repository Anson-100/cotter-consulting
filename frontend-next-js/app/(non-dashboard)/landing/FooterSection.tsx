// src/app/(nondashboard)/(landing)/FooterSection.tsx
"use client"
...
const navigation: { main: NavLink[]; social: SocialLink[] } = {
  main: [
    { name: "How it works", href: "#sectionone" },
    { name: "Features", href: "#sectionthree" },
    { name: "Pricing", href: "#sectiontwo" },
...
export default function FooterSection({ setSelectedPage }: Props) {
  ...
  return (
    <footer className="bg-zinc-900 dark:bg-zinc-950 flex flex-col">
      <button
        onClick={handleBackToTop}
        className="w-full bg-zinc-900 cursor-pointer hover:bg-zinc-950 py-3 font-semibold text-center text-gray-200"
      >
        Back to top
      </button>

      <div className="mx-auto max-w-7xl flex flex-col items-center justify-center px-6 pt-16 mb-2 lg:px-8">
        ...
        <p className="mt-12 text-center text-gray-500">
          &copy; {new Date().getFullYear()} The Pirate Ship LLC. All rights
          reserved.
        </p>
      </div>
    </footer>
